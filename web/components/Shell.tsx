          ...
          <nav className="sticky top-0 z-30 border-b border-stratum/50 bg-ink/70 backdrop-blur-md">
            <div className="mx-auto flex h-16 max-w-6xl items-center gap-4 px-5">
              <a href="/" className="flex items-center gap-3">
                ...
                <span className="hidden bg-gradient-to-b from-[#F6FDFA] to-[#9FC9BC] bg-clip-text font-disp text-base font-extrabold tracking-[0.14em] text-transparent sm:inline">
                  HOODPOOL
                </span>
              </a>

              <div className="ml-2 flex items-center gap-1 rounded-xl border border-stratum/60 bg-ink/50 p-1">
                {TABS.map((t) => (
                  <Link
                    key={t.key}
                    href={t.href}
