...
export const WETH: TokenInfo = {
  ...
  decimals: 18,
  logoURI:
    "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'%3E%3Ccircle cx='16' cy='16' r='16' fill='%23627EEA'/%3E%3Cpath d='M16 5v8.1l6.9 3.1L16 5z' fill='%23fff' fill-opacity='.35'/%3E%3Cpath d='M16 5 9 16.2l7-3.1V5z' fill='%23fff' fill-opacity='.8'/%3E%3Cpath d='M16 21.7V27l7-9.7-7 4.4z' fill='%23fff' fill-opacity='.35'/%3E%3Cpath d='M16 27v-5.3l-7-4.4L16 27z' fill='%23fff' fill-opacity='.8'/%3E%3C/svg%3E",
};
...
export const CORE_TOKENS: TokenInfo[] = [NATIVE_ETH, WETH, USDG, USDE];
